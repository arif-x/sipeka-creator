  ...
  <div class="container flex-horizontal position-relative">
    <div class="col lg-7 md-12">
      ...
      <div class="header-content-wrapper-3">
        ...
        <a href="<?= base_url('event-ekraf/') . $latest_single[0]['nama_event'] ?>" class="color-body-text white-md w-inline-block">
          <h1 class="margin-bottom-small"><?= $latest_single[0]['nama_event'] ?></h1>
          <div class="margin-bottom text-large"></div>
          </br>
          </br>
        </a><a href="<?= base_url('event-ekraf/') . $latest_single[0]['nama_event'] ?>" class="cta-link"><span class="margin-right">Lihat Lebih Lanjut</span> <span class="fa c-cta1_arrow-hovered"></span> <span class="fa c-cta1__arrow-normal"></span></a>
      </div>
    </div>
...
<div class="section">
  <div class="container flex-horizontal container-wrap">
    <?php foreach ($event as $key => $value) { ?>
      <div class="col lg-4 md-12 margin-bottom-quad"><a href="<?= base_url('event-ekraf/') . $value['slug'] ?>" class="w-inline-block"><img src="<?= $value['thumbnail'] ?>" alt="" class="margin-bottom img-news"></a>
        <div class="c-gridpost__category"><a href="#"><?= $value['kategori_event'] ?></a></div>
        <h3 class="margin-bottom-small"><?= $value['nama_event'] ?></h3><a href="<?= base_url('event-ekraf/') . $value['slug'] ?>" class="cta-link"><span class="margin-right">Lihat Lebih Lanjut</span> <span class="fa c-cta1_arrow-hovered"></span> <span class="fa c-cta1__arrow-normal"></span></a>
      </div>
